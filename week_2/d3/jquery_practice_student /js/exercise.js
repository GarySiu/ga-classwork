...
//$('img').mouseover http://placehold.it/200x300

function changeImage(event){
  var imageUrl = event.type === 'mouseover' ? 'http://placehold.it/200x300' : 'http://placehold.it/300x200'
}
$(document).ready(function(){
  $('.kitty').on('mouseover', changeImage);
});
/**
 * Question 11:
